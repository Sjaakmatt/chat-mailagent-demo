/**
 * Werkbak, modus **afhandelen** — het ticketscherm van klantenservice.
 *
 * Stond tot fase 4 als pagina in `ui/app/(dashboard)/tickets/`. Dat was een
 * schil-map met de schermen van één module erin; een tweede module met eigen
 * werkvoorraad had daar niets naast kunnen zetten zonder de schil te bewerken.
 * De route blijft bestaan en doet nog één ding: de rechtencontrole. Wat er
 * staat, komt hiervandaan.
 */
 ...
 */
export async function TicketsScreen({
  searchParams,
  user,
}: {
  searchParams: Promise<{ focus?: string }>;
  /** Komt van de route, die de rechtencontrole al deed. */
  user: AuthedAccess;
}) {
